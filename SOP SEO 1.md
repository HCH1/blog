...
## https://seo.whoops.com.tw/google-eat-3-point/
## Google EAT 分別代表了：
- 專業性
- 權威性
- 可靠性
...
## Google 質量評分指南
質量評分指南主要是提供 Google SEO 人員針對網站進行評估所使用的
...
## https://seo.whoops.com.tw/seo-rank-fast-5-tips/
## 5 個能夠幫助你快速提升網站排名的 SEO 教學，分別為：
- 優化文章標題、文章網址和文章敘述。
- 提供有價值的內容與最新的資訊。
- 優化網站速度，提升使用者體驗。
- 採用 ```RWD 讓網站符合行動裝置瀏覽體驗。
- 使用 Google Search Console 管理你的網站。
