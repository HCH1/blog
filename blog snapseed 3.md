# 3分鐘學會修圖軟體snapseed之功能:有選擇的Selective。推薦與教學(2019連載) One of the best photo filter app!
...
（用革命性的U點技術在幾秒鐘內精確選擇和增強圖像的特定區域。輕擊，然後輕擊圖像的所需區域以放置控制點。使用捏動手勢查看將受到影響的區域，顯示為紅色覆蓋。若要增加或減少受影響區域的大小，請使用捏動手勢來更改紅色覆蓋的大小。要編輯所選內容，首先要確保控制點以藍色突出顯示。如果是灰色的，點一下。垂直滑動來訪問編輯菜單，一旦選擇了一個選項，水平滑動來增強）
