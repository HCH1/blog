...
其實挑手錶給自己，最簡單就是兩句話：
1. 錢花得爽 (能力所及的消費是最舒服的)
1. 錶看得爽 (出門戴著，心情愉悅，耐用戴個十幾年，就物超所值了)
...
## 本篇專題介紹 超霸系列Speedmaster
手錶品牌除了做工和專利之外，另一個值得玩味的就是與歷史的羈絆，例如BALL手錶與火車計時歷史有關，ROLEX迪通拿與賽車歷史相關，而OMEGA則就是與美國太空史有歷史淵源。

去年剛接觸機械錶，也研究了一些品牌 型號 歷史背景等等。現在回想起來，對手錶的外型喜好竟然一直在改變:
1. 最初很喜歡機芯部分外透。因為覺得很美也可欣賞游絲的律動。Hamilton的開心系列實在好看。
1. 後來又突然對夜光感興趣，看了一些之後，覺得BALL系列有很多好的技術，只是較少人關注的牌子。
1. 過了幾個月後，又突然對潛水錶外型感到興趣。像是seamaster 300m箭頭指針實在粗曠美。潛水錶寬偏大，約42mm以上，且偏厚和重。手細的人會較難駕馭。
1. 後來愛上錶面罕見的顏色，像是綠色等等。RADO的庫克系列就很多顏色!
1. 最近看韓劇the king覺得浪琴計時錶滿美的，後來發現彭于晏也是代言(人帥帶啥都好看XD)，查多資料後注意到speedmaster系列滿多的外型也讚，也比較了兩眼計時和三眼計時，還有位置和功能等等，最後入手了一只老錶speedmaster三重日期。
...
![f1](https://github.com/HCH1/blog/blob/master/fig/speedmaster1a.jpg)
...
約1993年問世，它由原始的Omega 1150機芯提供動力。除了標準的計時功能外，左邊看24小時，錶盤周長看日期，上面左看星期，上面右看月份。指針外型為長劍型。
非常適合那些尋求與眾不同之處以及一些其他復雜功能的快速愛好者。

Omega 1151是Omega的ETA 7751版本。ETA 7750系列有3個等級，最低的是Elabore等級，其次是Top等級。 
1151中的材料與ETA中的Top相同，因此使用了最好的擺輪游絲和擺輪材料，最好的主發條材料等。頂級和天文台認證等級之間的唯一區別是，天文鐘錶等級是通過COSC測試。
...
在不銹鋼模型上，月球圖像與NASA照片一樣詳細。這是通過在金屬晶體盤上的特殊微結構化技術獲得的。仔細觀察，您甚至可以看到增加的宇航員的足跡。

革命性的新型9904和9905機芯由368個零件組成，標誌著製表業一個全新時代的開始：同軸天文台精密時計登陸。

防磁，計時碼表，天文台，精密天文鐘認證，月相，測速儀，透明底蓋
...
在收到申請的10家製造商中，只有4家提交了手錶供NASA考慮: 浪琴Longines 235T，勞力士Rolex Cosmograph，漢米爾頓Hamilton和歐米茄Omega超霸。
但是Hamilton提交了一塊懷錶，被取消了參賽資格...來亂的XD
